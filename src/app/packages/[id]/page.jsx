...
export default function PackagePage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1611] via-[#231f10] to-[#2a251a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Breadcrumb */}
        <nav className="flex items-center space-x-2 text-sm mb-8">
          <Link href="/" className="text-[#cdc08e] hover:text-[#e3b602] transition-colors">
            Home
          </Link>
          <span className="text-[#6a5e2f]">/</span>
          <Link href="/" className="text-[#cdc08e] hover:text-[#e3b602] transition-colors">
            Packages
          </Link>
          <span className="text-[#6a5e2f]">/</span>
            ...
            <div className="absolute bottom-8 left-8 right-8">
              <div className="max-w-2xl">
                ...
                <div className="flex flex-wrap items-center gap-6">
                  <div className="flex items-center text-[#e3b602]">
                  ...
                  <div className="text-3xl font-bold text-[#e3b602]">
                    {travelPackage.price}
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            {/* Gallery Section */}
            <section className="bg-[#231f10]/50 backdrop-blur-sm rounded-2xl p-8 border border-[#4a4221]/30">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-3xl font-bold text-white">Gallery</h2>
                <button
                  onClick={() => setShowAllImages(!showAllImages)}
                  className="text-[#e3b602] hover:text-[#cdc08e] transition-colors font-medium"
                >
                ...
                {travelPackage.highlights ? (
                  travelPackage.highlights.slice(0, 5).map((highlight, index) => (
                    <div key={index} className="flex items-start gap-4 group">
                      <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-[#e3b602] to-[#cdc08e] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                        {index === 0 && (
                          <svg className="w-6 h-6 text-[#231f10]" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                          </svg>
                        )}
                        {index === 1 && (
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-400">Experience this amazing feature of your travel package.</p>
                      </div>
                    </div>
                  ))
                ) : (
                  <>
                    <div className="flex items-start gap-4 group">
                      <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-[#e3b602] to-[#cdc08e] rounded-xl flex items-center justify-center">
                        <svg className="w-6 h-6 text-[#231f10]" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-400">Indulge in authentic local cuisine and international dishes.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 group">
                      <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-[#e3b602] to-[#cdc08e] rounded-xl flex items-center justify-center">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-400">Explore the destination with expert local guides.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 group">
                      <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-[#e3b602] to-[#cdc08e] rounded-xl flex items-center justify-center">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-400">Enjoy a perfect balance of relaxation and adventure.</p>
                      </div>
                    </div>
                  </>
                )}
            ...
            {/* Itinerary */}
            <section className="bg-[#231f10]/50 backdrop-blur-sm rounded-2xl p-8 border border-[#4a4221]/30">
              <h2 className="text-3xl font-bold text-white mb-8">Itinerary</h2>
              <div className="relative">
                <div className="absolute left-6 top-16 bottom-16 w-0.5 bg-gradient-to-b from-[#e3b602] to-[#cdc08e]"></div>
                <div className="space-y-8">
                  <div className="flex items-start gap-6">
                    <div className="relative z-10 w-12 h-12 bg-gradient-to-r from-[#e3b602] to-[#cdc08e] rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-6 h-6 text-[#231f10]" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="flex-1 pt-1">
                      ...
                      <p className="text-[#e3b602] font-medium mb-2">Day 1</p>
                      <p className="text-gray-400">Welcome to your destination! Check into your premium accommodation and begin your adventure.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1 pt-1">
                      ...
                      <p className="text-[#e3b602] font-medium mb-2">Days 2-{parseInt(travelPackage.duration) || '6'}</p>
                      <p className="text-gray-400">Discover the highlights of your destination with guided tours, cultural experiences, and adventure activities.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1 pt-1">
                      ...
                      <p className="text-[#e3b602] font-medium mb-2">Final Day</p>
                      <p className="text-gray-400">Check out and departure with unforgettable memories of your journey.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-8">
              {/* Accommodation */}
              <section className="bg-[#231f10]/50 backdrop-blur-sm rounded-2xl p-6 border border-[#4a4221]/30">
              ...
              {/* Pricing */}
              <section className="bg-gradient-to-br from-[#e3b602] to-[#cdc08e] rounded-2xl p-6 text-[#231f10]">
                ...
                <div className="space-y-4">
                  ...
                  <Link href="/tour-request" className="block">
                    <button className="w-full bg-[#231f10] text-[#e3b602] font-bold py-4 px-6 rounded-xl hover:bg-[#1a1611] transition-colors transform hover:scale-105 duration-200">
                      Book Now
                    </button>
                  </Link>
                </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90" onClick={closeImageModal}>
            <div className="relative max-w-4xl max-h-[90vh] w-full mx-4">
              <button
                ...
                className="absolute top-4 right-4 z-10 text-white hover:text-[#e3b602] transition-colors"
              >
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-black/60 backdrop-blur-sm rounded-lg p-4">
                <h3 className="text-white font-semibold text-lg">{displayImages[selectedImageIndex].title}</h3>
                <p className="text-gray-300">{displayImages[selectedImageIndex].category}</p>
              </div>
              ...
              {displayImages.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white hover:text-[#e3b602] transition-colors"
                  >
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white hover:text-[#e3b602] transition-colors"
                  >
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
